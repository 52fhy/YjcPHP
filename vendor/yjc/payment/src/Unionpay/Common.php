<?php
namespace Yjc\Payment\Unionpay;
class Common
{
	// cvn2加密 1：加密 0:不加密
	...
	public static function setCertPwd($cert_pwd){
	 ...
	 * @return string
	 */
	public static function coverParamsToString($params)
	{
		$sign_str = '';
		// 排序
		ksort ( $params );
	 ...
	 */
	public static function deal_params(&$params)
	{
		/**
		 * 解码 customerInfo
		 */
	 ...
	 * @param unknown_type $params
	 */
	public static function deflate_file(&$params)
	{
	 ...
	 * @param unknown_type $params
	 */
	public static function deal_file($params)
	{
	 ...
	 * @return string
	 */
	public static function create_html($params, $action)
	{
